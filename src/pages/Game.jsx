				...
				<div className="Games pt-10">
					<div className= "overlayGames flex-col flex  justify-between items-center ">
						...
						<div className="bim test flex items-end justify-center pb-25">
							...
							<button className = "buttonSend flex item-center justify-center w-9 h-6"> <svg xmlns="http://www.w3.org/2000/svg" className="bam" height="100%" viewBox="0 -960 960 960" width="100%" fill="#FFFADE"><path d="M120-160v-640l760 320-760 320Zm80-120 474-200-474-200v140l240 60-240 60v140Zm0 0v-400 400Z"/></svg> </button>
						</div>
					</div>
