			...
			<div className= 'overlay '>
				...
				<div className="Games">
					<div className= "overlayGames flex-col flex  justify-between items-center ">
						<h2> Join the game</h2>
						<div className="bim flex flex-row items-center  ">
							<Input classnameI="code text-black " classnameL="text-white" type="Code :	" id="id" text='xxxx' value={code} set={setCode} /> 
							<button className = "buttonSend "> <svg xmlns="http://www.w3.org/2000/svg" height="100%" viewBox="0 -960 960 960" width="100%" fill="#FFFADE"><path d="M120-160v-640l760 320-760 320Zm80-120 474-200-474-200v140l240 60-240 60v140Zm0 0v-400 400Z"/></svg> </button>
						</div>
					</div>
					<div className = "overlayGames flex-col flex  " >
						<div className="bim flex flex-col justify-between">
							...
							<p className="flex flex-row justify-center items-center"> <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e3e3e3"><path d="M383-480 200-664l56-56 240 240-240 240-56-56 183-184Zm264 0L464-664l56-56 240 240-240 240-56-56 183-184Z"/></svg> <Button value="buttonP"text="Play"/> <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#e3e3e3"><path d="M440-240 200-480l240-240 56 56-183 184 183 184-56 56Zm264 0L464-480l240-240 56 56-183 184 183 184-56 56Z"/> </svg> </p>
						</div>
					</div>
