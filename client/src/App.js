					...
					<div className="Foot">
						...
						<div className="ToolsEnsemble">
							...
							<div className="Thickness">
								<button onClick={() => set_select_thickness("thin")} className={`${"ToolButton"} ${"Fine_thickness"}`}>
									<svg xmlns="http://www.w3.org/2000/svg" height="100%" viewBox="0 -960 960 960" width="100%" fill="#000000"><path d="M280-200q-33 0-56.5-23.5T200-280q0-15 6-29.5t18-26.5l400-400q12-12 26.5-18t29.5-6q33 0 56.5 23.5T760-680q0 15-5.5 30T737-623L337-223q-12 12-26.5 17.5T280-200Z"/></svg>
								</button>
								<button onClick={() => set_select_thickness("medium")} className={`${"ToolButton"} ${"Medium_thickness"}`}>
									<svg xmlns="http://www.w3.org/2000/svg" height="100%" viewBox="0 -960 960 960" width="100%" fill="#000000"><path d="M340-200q-58 0-99-41t-41-99q0-27 10.5-53t30.5-46l280-280q20-20 46-30.5t53-10.5q58 0 99 41t41 99q0 27-10.5 53T719-521L439-241q-20 20-46 30.5T340-200Z"/></svg>
								</button>
								<button onClick={() => set_select_thickness("thick")} className={`${"ToolButton"} ${"Thick_thickness"}`}>
									<svg xmlns="http://www.w3.org/2000/svg" height="100%" viewBox="0 -960 960 960" width="100%" fill="#000000"><path d="M402-120q-118 0-200-82t-82-200q0-54 20-105.5t62-93.5l157-157q42-42 93.5-62T558-840q118 0 200 82t82 200q0 54-20 105.5T758-359L601-202q-42 42-93.5 62T402-120Z"/></svg>
								</button>
								&nbsp;&nbsp;
