	...
	<main className='main2 bg-[#4D007E]' >
		<div className="w-full md:ml-100 md:mr-100 mb-5 " >
			...
			<p> • Username<br/>
				...
				• Profile information (avatar, preferences)<br/><br/></p>
			...
			<p>• Provide and maintain the service<br/>
			• Enable real-time multiplayer<br/>
			• Manage authentication and security<br/>
			• Maintain game history and statistics<br/>
			• Improve the user experience<br/><br/></p>
			<h2 className="text-4xl font-bold" >4. Data Sharing</h2>
			<p>We do not sell your personal data or share it for commercial purposes with third parties.<br/>
			...
			<p>Data is retained only for as long as necessary for the application to function.<br/>
			You can request the deletion of your data.<br/></p>

			<h2 className="text-4xl font-bold" >7. Your Rights </h2>
			<p>In accordance with applicable regulations (including the GDPR), you have the following rights:<br/><br/>

			• Access your personal data <br/>
			• Request rectification or erasure<br/>
			• Objection to processing <br/><br/>

			To exercise these rights, contact the project maintainers. <br/></p>
			
			<h2 className="text-4xl font-bold" >8. Third-Party Services</h2>
			<p>The application relies in particular on:<br/><br/>
			• Google API (OAuth authentication) <br/><br/>	
			We are not responsible for the privacy practices of third parties.</p>

			<h2 className="text-4xl font-bold" >9. Changes to this Policy</h2>
			<p>This privacy policy may be updated at any time.<br/>
			Users will be notified of significant changes.</p>

			<h2 className="text-4xl font-bold" >10. Contact</h2>
			<p>For any questions regarding this privacy policy, please contact the project team.
