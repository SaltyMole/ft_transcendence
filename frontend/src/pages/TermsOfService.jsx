...
function TermsOfService()
{
	...
	<main className='main2 bg-[#4D007E]' >
		<div className="w-full md:ml-100 md:mr-100 mb-10 ">
			...
			<BackButton/>
			<p className="text-right"> Last updated: [06/25/2026]</p>
			...
			Users retain ownership of the content they publish on the platform.<br/>
			However, they grant Transcendance limited authorization to use such content solely to the extent necessary for the operation of the service.</p>
